...
public class MenuItem extends JButton {
    ...
    public MenuItem() {
        ...
        setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/wb/controle_pessoal/icon/menu.png")));
        initStyle();
    }

    private void initStyle() {
        Color color = UIManager.getColor("br.com.wb.controle_pessoal.menu.ripplecolor");
        if (color != null) {
